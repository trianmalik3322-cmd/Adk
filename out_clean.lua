...
Main = (function()
	...
	-- ═══════════════════════════════════════════════════════════
	-- COOL ANIMATED INTRO - Modified by AI
	-- Features: Glitch FX, Corner Accents, Gradient Progress Bar,
	--           Cyan/Purple Theme, Pulse Glow, Scanline Overlay
	-- ═══════════════════════════════════════════════════════════
	Main.CreateIntro = function(initStatus)
		-- Color palette
		local COLOR_BG        = Color3.fromRGB(8, 8, 20)
		local COLOR_HOLDER    = Color3.fromRGB(12, 12, 28)
		local COLOR_CYAN      = Color3.fromRGB(0, 220, 255)
		local COLOR_PURPLE    = Color3.fromRGB(180, 80, 255)
		local COLOR_TEXT      = Color3.fromRGB(200, 230, 255)
		local COLOR_SUBTEXT   = Color3.fromRGB(120, 160, 210)

		local gui = create({
			{1,"ScreenGui",{Name="Intro",}},
			-- Main window (slightly larger: 400x230)
			{2,"Frame",{Active=true,BackgroundColor3=COLOR_BG,BorderSizePixel=0,Name="Main",Parent={1},Position=UDim2.new(0.5,-200,0.5,-115),Size=UDim2.new(0,400,0,230),}},
			-- Holder (clips children for wipe reveal)
			{3,"Frame",{BackgroundColor3=COLOR_HOLDER,BorderSizePixel=0,ClipsDescendants=true,Name="Holder",Parent={2},Size=UDim2.new(1,0,1,0),}},
			-- Holder reveal gradient
			...
			-- Title label
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-220,0,18),Size=UDim2.new(0,130,0,52),Text="Dex++",TextColor3=COLOR_CYAN,TextSize=52,TextTransparency=1,RichText=true,}},
			-- Desc label
			{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-270,0,72),Size=UDim2.new(0,220,0,22),Text="Ultimate Debugging Suite",TextColor3=COLOR_TEXT,TextSize=15,TextTransparency=1,}},
			-- Separator line (accent bar under desc)
			{7,"Frame",{BackgroundColor3=COLOR_CYAN,BorderSizePixel=0,Name="Sep",Parent={3},Position=UDim2.new(0,20,0,96),Size=UDim2.new(0,0,0,1),BackgroundTransparency=1,}},
			-- Status text
			{8,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="StatusText",Parent={3},Position=UDim2.new(0,20,0,125),Size=UDim2.new(0,240,0,20),Text="Fetching API",TextColor3=COLOR_SUBTEXT,TextSize=13,TextTransparency=1,}},
			-- Progress bar background
			{9,"Frame",{BackgroundColor3=Color3.fromRGB(25,25,50),BorderSizePixel=0,Name="ProgressBar",Parent={3},Position=UDim2.new(0,130,0,158),Size=UDim2.new(0,0,0,5),}},
			-- Progress bar fill
			{10,"Frame",{BackgroundColor3=COLOR_CYAN,BorderSizePixel=0,Name="Bar",Parent={9},Size=UDim2.new(0,0,1,0),}},
			-- Gradient on the bar fill (cyan → purple)
			{11,"UIGradient",{Name="BarGradient",Parent={10},Color=ColorSequence.new({ColorSequenceKeypoint.new(0,COLOR_CYAN),ColorSequenceKeypoint.new(1,COLOR_PURPLE)}),Rotation=0,}},
			-- Progress bar outline
			{12,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://2764171053",ImageColor3=COLOR_HOLDER,Name="BarOutline",Parent={9},ScaleType=1,Size=UDim2.new(1,0,1,0),SliceCenter=Rect.new(2,2,254,254),}},
			-- Corner accent TL (vertical)
			{13,"Frame",{BackgroundColor3=COLOR_CYAN,BorderSizePixel=0,Name="CornerTLV",Parent={3},Position=UDim2.new(0,0,0,0),Size=UDim2.new(0,2,0,0),}},
			-- Corner accent TL (horizontal)
			{14,"Frame",{BackgroundColor3=COLOR_CYAN,BorderSizePixel=0,Name="CornerTLH",Parent={3},Position=UDim2.new(0,0,0,0),Size=UDim2.new(0,0,0,2),}},
			-- Corner accent BR (vertical)
			{15,"Frame",{BackgroundColor3=COLOR_PURPLE,BorderSizePixel=0,Name="CornerBRV",Parent={3},Position=UDim2.new(1,-2,1,0),AnchorPoint=Vector2.new(0,1),Size=UDim2.new(0,2,0,0),}},
			-- Corner accent BR (horizontal)
			{16,"Frame",{BackgroundColor3=COLOR_PURPLE,BorderSizePixel=0,Name="CornerBRH",Parent={3},Position=UDim2.new(1,0,1,-2),AnchorPoint=Vector2.new(1,0),Size=UDim2.new(0,0,0,2),}},
			-- Scanline overlay (subtle dark stripes)
			{17,"Frame",{BackgroundColor3=Color3.new(0,0,0),BackgroundTransparency=0.88,BorderSizePixel=0,Name="Scanlines",Parent={3},Size=UDim2.new(1,0,1,0),ZIndex=6,}},
			-- Creator label
			{18,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-130,1,-22),Size=UDim2.new(0,125,0,18),Text="Developed by Chillz.",TextColor3=COLOR_SUBTEXT,TextSize=13,TextXAlignment=1,}},
			{19,"UIGradient",{Parent={18},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			-- Version label
			{20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Version",Parent={2},Position=UDim2.new(1,-130,1,-38),Size=UDim2.new(0,125,0,18),Text=Main.Version,TextColor3=COLOR_SUBTEXT,TextSize=13,TextXAlignment=1,}},
			{21,"UIGradient",{Parent={20},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			-- Outer outline
			{22,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,Image="rbxassetid://1427967925",Name="Outlines",Parent={2},Position=UDim2.new(0,-5,0,-5),ScaleType=1,Size=UDim2.new(1,10,1,10),SliceCenter=Rect.new(6,6,25,25),TileSize=UDim2.new(0,20,0,20),}},
			{23,"UIGradient",{Parent={22},Rotation=-30,Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			{24,"UIGradient",{Parent={2},Rotation=-30,Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			{25,"UIDragDetector",{Parent={2}}}
		})
		Main.ShowGui(gui)
		...
		local sepLine         = gui.Main.Holder.Sep
		...
		local barFill         = progressBar.Bar
		local barGradient     = barFill.BarGradient
		local cornerTLV       = gui.Main.Holder.CornerTLV
		local cornerTLH       = gui.Main.Holder.CornerTLH
		local cornerBRV       = gui.Main.Holder.CornerBRV
		local cornerBRH       = gui.Main.Holder.CornerBRH
		...
		-- Tween helper for number animations
		...
		-- ── PHASE 1: Window reveal (wipe from center) ──────────────────
		local ti = TweenInfo.new(0.45, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
		...
		-- Slide title & desc in from left
		tweenS:Create(titleText, ti, {Position = UDim2.new(0, 55, 0, 18), TextTransparency = 0}):Play()
		tweenS:Create(descText,  ti, {Position = UDim2.new(0, 20, 0, 72), TextTransparency = 0}):Play()

		-- Version / creator fade in from right
		local function rightTextFade(obj)
			tweenNumber(100, ti, function(val)
				val = val / 100
		...
		rightTextFade(versionGradient)
		rightTextFade(creatorGradient)

		fastwait(0.5)

		-- ── PHASE 3: Corner accents draw in ───────────────────────────
		local cornerTI = TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
		tweenS:Create(cornerTLV, cornerTI, {Size = UDim2.new(0, 2, 0, 35)}):Play()
		tweenS:Create(cornerTLH, cornerTI, {Size = UDim2.new(0, 35, 0, 2)}):Play()
		tweenS:Create(cornerBRV, cornerTI, {Size = UDim2.new(0, 2, 0, 35)}):Play()
		tweenS:Create(cornerBRH, cornerTI, {Size = UDim2.new(0, 35, 0, 2)}):Play()

		-- Separator line expands
		tweenS:Create(sepLine, cornerTI, {Size = UDim2.new(0, 180, 0, 1), BackgroundTransparency = 0.5}):Play()

		fastwait(0.35)

		-- ── PHASE 4: Glitch flash on title (3 quick flickers) ─────────
		coroutine.wrap(function()
			local glitchOffsets = {-3, 3, -2, 2, 0}
			for _, offset in ipairs(glitchOffsets) do
				titleText.Position = UDim2.new(0, 55 + offset, 0, 18 + (offset ~= 0 and 1 or 0))
				titleText.TextColor3 = offset ~= 0 and Color3.fromRGB(255, 60, 120) or COLOR_CYAN
				fastwait(0.04)
			end
			titleText.Position    = UDim2.new(0, 55, 0, 18)
			titleText.TextColor3  = COLOR_CYAN
		end)()

		fastwait(0.1)

		-- ── PHASE 5: Status text & progress bar slide in ──────────────
		local progressTI = TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out)
		tweenS:Create(statusText, progressTI, {Position = UDim2.new(0, 20, 0, 130), TextTransparency = 0}):Play()
		...
		-- ── PHASE 6: Continuous gradient shimmer on progress bar ──────
		...
		coroutine.wrap(function()
			...
			while shimmerRunning do
				...
				local c2 = Color3.fromHSV((hue + 0.28) % 1, 0.85, 1)
		...
		-- ── PHASE 7: Subtle corner pulse loop ─────────────────────────
		local pulseRunning = true
		coroutine.wrap(function()
			local pulseTI_in  = TweenInfo.new(0.6, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut)
			local pulseTI_out = TweenInfo.new(0.6, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut)
			while pulseRunning do
				tweenS:Create(cornerTLV, pulseTI_in,  {BackgroundTransparency = 0.5}):Play()
				tweenS:Create(cornerTLH, pulseTI_in,  {BackgroundTransparency = 0.5}):Play()
				tweenS:Create(cornerBRV, pulseTI_in,  {BackgroundTransparency = 0.5}):Play()
				tweenS:Create(cornerBRH, pulseTI_in,  {BackgroundTransparency = 0.5}):Play()
				fastwait(0.6)
				tweenS:Create(cornerTLV, pulseTI_out, {BackgroundTransparency = 0}):Play()
				tweenS:Create(cornerTLH, pulseTI_out, {BackgroundTransparency = 0}):Play()
				tweenS:Create(cornerBRV, pulseTI_out, {BackgroundTransparency = 0}):Play()
				tweenS:Create(cornerBRH, pulseTI_out, {BackgroundTransparency = 0}):Play()
				fastwait(0.6)
			end
		end)()

		-- ── setProgress ───────────────────────────────────────────────
		local progressUpdateTI = TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
		local function setProgress(text, n)
			statusText.Text = text
			tweenS:Create(barFill, progressUpdateTI, {Size = UDim2.new(n, 0, 1, 0)}):Play()
		end
		...
		local function close()
			...
			local closeTI = TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)

			-- Second glitch burst before close
			coroutine.wrap(function()
				for i = 1, 4 do
					local ox = math.random(-4, 4)
					titleText.Position   = UDim2.new(0, 55 + ox, 0, 18)
					titleText.TextColor3 = i % 2 == 0 and COLOR_PURPLE or COLOR_CYAN
					fastwait(0.035)
				end
				titleText.Position   = UDim2.new(0, 55, 0, 18)
				titleText.TextColor3 = COLOR_CYAN
			...
			tweenS:Create(titleText,   closeTI, {TextTransparency = 1}):Play()
			tweenS:Create(descText,    closeTI, {TextTransparency = 1}):Play()
			tweenS:Create(versionText, closeTI, {TextTransparency = 1}):Play()
			tweenS:Create(creatorText, closeTI, {TextTransparency = 1}):Play()
			tweenS:Create(statusText,  closeTI, {TextTransparency = 1}):Play()
			tweenS:Create(sepLine,     closeTI, {BackgroundTransparency = 1}):Play()
			tweenS:Create(progressBar, closeTI, {BackgroundTransparency = 1}):Play()
			tweenS:Create(barFill,     closeTI, {BackgroundTransparency = 1}):Play()
			tweenS:Create(progressBar.BarOutline, closeTI, {ImageTransparency = 1}):Play()

			-- Retract corner accents
			tweenS:Create(cornerTLV, closeTI, {Size = UDim2.new(0, 2, 0, 0)}):Play()
			tweenS:Create(cornerTLH, closeTI, {Size = UDim2.new(0, 0, 0, 2)}):Play()
			tweenS:Create(cornerBRV, closeTI, {Size = UDim2.new(0, 2, 0, 0)}):Play()
			tweenS:Create(cornerBRH, closeTI, {Size = UDim2.new(0, 0, 0, 2)}):Play()

			-- Holder collapse (wipe back)
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║          DEX++ CINEMATIC CUTSCENE  (LocalScript only)       ║
-- ║  Parts dibuat di workspace, cuma keliatan kita sendiri.     ║
-- ║  Camera dianimasiin manual. Habis cutscene → Main.Init()    ║
-- ╚══════════════════════════════════════════════════════════════╝
local function PlayDexCutscene(onFinish)
	...
	local DARK   = Color3.fromRGB(5, 5, 20)
	...
	-- ── Utility: buat Part lokal (tidak direplikasi) ──────────────
	local cutsceneParts = {}  -- track untuk cleanup
	...
	vignette.Image              = "rbxassetid://1428546737"   -- radial gradient
	vignette.ImageColor3        = BLACK
	...
	titleLabel.TextSize         = 62
	titleLabel.TextColor3       = CYAN
	...
	subLabel.Size              = UDim2.new(0,500,0,30)
	...
	subLabel.TextColor3        = WHITE
	subLabel.TextTransparency  = 1
	subLabel.ZIndex            = 8

	-- Bottom tag line
	local tagLabel = Instance.new("TextLabel", cutsceneGui)
	tagLabel.Size              = UDim2.new(0,400,0,20)
	tagLabel.AnchorPoint       = Vector2.new(0.5,1)
	tagLabel.Position          = UDim2.new(0.5,0,1,-60)
	tagLabel.BackgroundTransparency = 1
	tagLabel.Text              = "LOADING..."
	tagLabel.Font              = Enum.Font.Code
	tagLabel.TextSize          = 13
	tagLabel.TextColor3        = CYAN
	tagLabel.TextTransparency  = 1
	tagLabel.ZIndex            = 8

	-- Thin cyan line accent (center)
	local lineAccent = Instance.new("Frame", cutsceneGui)
	lineAccent.Size             = UDim2.new(0,0,0,1)
	lineAccent.AnchorPoint      = Vector2.new(0.5,0.5)
	lineAccent.Position         = UDim2.new(0.5,0,0.5,48)
	lineAccent.BackgroundColor3 = CYAN
	lineAccent.BorderSizePixel  = 0
	lineAccent.BackgroundTransparency = 1
	lineAccent.ZIndex           = 8

	-- ── Override camera ───────────────────────────────────────────
	camera.CameraType = Enum.CameraType.Scriptable

	-- ── SCENE SETUP: Buat Parts ───────────────────────────────────
	-- Arena platform
	local platform = makePart({
		Size     = Vector3.new(60, 1, 60),
		Color    = Color3.fromRGB(5, 5, 18),
		Material = Enum.Material.SmoothPlastic,
		Position = Vector3.new(0, -3, 0),
		CFrame   = CFrame.new(0, -3, 0)
	})

	-- Grid lines di platform (neon)
	local gridParts = {}
	for i = -3, 3 do
		local hLine = makePart({
			Size     = Vector3.new(60, 0.05, 0.05),
			Color    = CYAN,
			Material = Enum.Material.Neon,
			CFrame   = CFrame.new(0, -2.47, i * 4)
		})
		hLine.Transparency = 0.7
		table.insert(gridParts, hLine)

		local vLine = makePart({
			Size     = Vector3.new(0.05, 0.05, 60),
			Color    = PURPLE,
			Material = Enum.Material.Neon,
			CFrame   = CFrame.new(i * 4, -2.47, 0)
		})
		vLine.Transparency = 0.7
		table.insert(gridParts, vLine)
	end

	-- Central floating cube (logo proxy)
	local cube = makePart({
	...
	-- Inner cube (smaller, purple)
	local innerCube = makePart({
		Size     = Vector3.new(1.5, 1.5, 1.5),
		Color    = PURPLE,
		Material = Enum.Material.Neon,
		CFrame   = CFrame.new(0, 5, 0)
	})
	innerCube.Transparency = 0.1

	-- Ring parts (orbit ring simulasi)
	local ringParts = {}
	local ringCount = 12
	for i = 1, ringCount do
		local angle = (i / ringCount) * math.pi * 2
		local rx = math.cos(angle) * 6
		local rz = math.sin(angle) * 6
		local rp = makePart({
			Size     = Vector3.new(0.4, 0.4, 0.4),
			Color    = i % 2 == 0 and CYAN or PURPLE,
			Material = Enum.Material.Neon,
			CFrame   = CFrame.new(rx, 5, rz)
		})
		rp.Transparency = 0.1
		table.insert(ringParts, rp)
	end

	-- Pillar / spike accents (4 sudut)
	local pillars = {}
	for _, pos in ipairs({
		Vector3.new(-8, 0, -8),
		Vector3.new(8, 0, -8),
		...
		local pillar = makePart({
			...
			Color    = PINK,
			Material = Enum.Material.Neon,
			CFrame   = CFrame.new(pos.X, pos.Y + 2.5, pos.Z)
		})
		...
		local topBall = makePart({
			...
			Color    = WHITE,
			Material = Enum.Material.Neon,
			CFrame   = CFrame.new(pos.X, pos.Y + 8, pos.Z)
		})
		topBall.Transparency = 0.2
		table.insert(pillars, topBall)
	end

	-- Floating debris (small random blocks)
	local debris = {}
	...
	for i = 1, 18 do
		...
		local db = makePart({
			...
			Color    = (i % 3 == 0) and CYAN or (i % 3 == 1) and PURPLE or PINK,
			Material = Enum.Material.Neon,
			CFrame   = CFrame.new(
		...
		db.Transparency = math.random(1,4) * 0.15
		table.insert(debris, db)
	end

	-- ── FASE 0: Black screen, letterbox masuk ─────────────────────
	local barTI = TweenInfo.new(0.6, Enum.EasingStyle.Quint, Enum.EasingDirection.Out)
	tw(barTop, barTI, {Size = UDim2.new(1,0,0,55)})
	tw(barBot, barTI, {Size = UDim2.new(1,0,0,55)})

	-- Posisi kamera awal (zoom out dari atas)
	camera.CFrame = CFrame.new(0, 30, 0) * CFrame.Angles(math.rad(-90), 0, 0)

	fw(0.7)

	-- ── FASE 1: Fade in scene (blackFrame fade out) ───────────────
	tw(blackFrame, TweenInfo.new(1.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		{BackgroundTransparency = 1})

	-- Kamera bergerak: top-down → turun ke depan
	local camTI1 = TweenInfo.new(2.0, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut)
	tw(camera, camTI1, {
		CFrame = CFrame.new(18, 8, 18) * CFrame.Angles(math.rad(-20), math.rad(45), 0)
	})

	fw(1.0)

	-- ── FASE 1b: Cube + ring mulai animasi ────────────────────────
	-- Cube rotate loop
	local cubeAngle = 0
	local cubeAnim = RunService.RenderStepped:Connect(function(dt)
		cubeAngle = cubeAngle + dt * 55
		cube.CFrame      = CFrame.new(0, 5 + math.sin(tick()*1.5)*0.4, 0)
			* CFrame.Angles(math.rad(cubeAngle), math.rad(cubeAngle*0.7), 0)
		innerCube.CFrame = CFrame.new(0, 5 + math.sin(tick()*1.5)*0.4, 0)
			* CFrame.Angles(math.rad(-cubeAngle*1.2), math.rad(cubeAngle*0.5), 0)

		-- Ring orbit
		for i, rp in ipairs(ringParts) do
			local a = ((i / ringCount) * math.pi * 2) + tick() * 1.2
			rp.CFrame = CFrame.new(
				math.cos(a) * 6,
				5 + math.sin(tick()*0.8 + i) * 0.3,
				math.sin(a) * 6
			)
		end
		...
		for i, db in ipairs(debris) do
			db.CFrame = db.CFrame * CFrame.Angles(0, math.rad(dt*30), 0)
				+ Vector3.new(0, math.sin(tick()*0.5 + i*0.4) * dt * 0.5, 0)
		end

		-- Pillar glow ball pulse
		for i, p in ipairs(pillars) do
			if i % 2 == 0 then
				p.Transparency = 0.2 + math.abs(math.sin(tick()*2 + i)) * 0.5
			end
		end
	end)
	...
	-- ── FASE 2: Kamera sweep ke kiri ──────────────────────────────
	tw(camera, TweenInfo.new(2.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
		CFrame = CFrame.new(-20, 5, 12) * CFrame.Angles(math.rad(-10), math.rad(-50), 0)
	})

	-- Pillar muncul (tween height)
	for _, p in ipairs(pillars) do
		if p.Size.Y > 1 then  -- hanya pillar (bukan bola)
			local origSize = p.Size
			p.Size = Vector3.new(origSize.X, 0.1, origSize.Z)
			p.CFrame = p.CFrame * CFrame.new(0, -origSize.Y/2 + 0.05, 0)
			tw(p, TweenInfo.new(0.8, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
				Size  = origSize,
				CFrame = CFrame.new(
					p.CFrame.X, p.CFrame.Y + origSize.Y/2, p.CFrame.Z
				)
			})
		end
	end
	...
	-- ── FASE 3: Text reveal ───────────────────────────────────────
	-- Line accent expand
	tw(lineAccent, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
	...
	-- Subtitle fade in
	tw(subLabel, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		TextTransparency = 0
	})
	...
	-- Tag + line
	tw(tagLabel, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		TextTransparency = 0.3
	})

	fw(0.5)

	-- ── FASE 4: Kamera maju ke cube (cinematic push-in) ───────────
	tw(camera, TweenInfo.new(1.8, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
		CFrame = CFrame.new(0, 7, 14) * CFrame.Angles(math.rad(-12), 0, 0)
	})
	...
	coroutine.wrap(function()
		...
		for i = 1, 6 do
			...
			titleLabel.Position = UDim2.new(0.5, ox, 0.5, 0)
			titleLabel.TextColor3 = i%2==0 and PINK or CYAN
			fw(0.04)
		end
		titleLabel.Position   = UDim2.new(0.5,0,0.5,0)
		titleLabel.TextColor3 = CYAN
	...
	-- ── FASE 5: Flash + blackout (end cutscene) ───────────────────
	-- White flash
	...
	tw(flashFrame, TweenInfo.new(0.12, Enum.EasingStyle.Linear), {BackgroundTransparency = 0})
	fw(0.12)
	...
	tw(flashFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		BackgroundTransparency = 1
	})

	-- Letterbox hilang
	tw(barTop, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
		Size = UDim2.new(1,0,0,0)
	})
	tw(barBot, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
		Size = UDim2.new(1,0,0,0)
	})

	fw(0.5)

	-- ── Cleanup: hapus semua part & gui ───────────────────────────
	for _, p in ipairs(cutsceneParts) do
		pcall(function() p:Destroy() end)
	end
	cutsceneGui:Destroy()

	-- Restore kamera ke original
...
-- Kalau cutscene error (e.g. bukan LocalScript / env tidak support),
-- langsung Init aja biar DEX tetap jalan
if not ok then
