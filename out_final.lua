...
Main = (function()
	...
	-- ═══════════════════════════════════════════════════════════
	-- RAINBOW GLOW INTRO - Modified by AI
	-- Features: Rainbow Glow Title, Animated Loading Dots,
	--           Rainbow Progress Bar, Floating Orbs BG,
	--           Bouncing Bar, Glitch FX, Corner Accents
	-- ═══════════════════════════════════════════════════════════
	Main.CreateIntro = function(initStatus)
		local COLOR_BG     = Color3.fromRGB(5, 5, 15)
		local COLOR_HOLDER = Color3.fromRGB(10, 10, 25)
		local COLOR_WHITE  = Color3.fromRGB(255, 255, 255)
		local COLOR_DARK   = Color3.fromRGB(20, 20, 40)

		local gui = create({
			{1,"ScreenGui",{Name="Intro",}},
			{2,"Frame",{Active=true,BackgroundColor3=COLOR_BG,BorderSizePixel=0,Name="Main",Parent={1},Position=UDim2.new(0.5,-210,0.5,-125),Size=UDim2.new(0,420,0,250),}},
			...
			-- Floating orb BG decorations
			{5,"Frame",{BackgroundColor3=Color3.fromRGB(0,180,255),BorderSizePixel=0,Name="Orb1",Parent={3},Position=UDim2.new(0,-30,0,-30),Size=UDim2.new(0,80,0,80),BackgroundTransparency=0.85,ZIndex=1,}},
			{6,"UICorner",{CornerRadius=UDim.new(1,0),Parent={5},}},
			{7,"Frame",{BackgroundColor3=Color3.fromRGB(180,0,255),BorderSizePixel=0,Name="Orb2",Parent={3},Position=UDim2.new(1,-50,1,-50),Size=UDim2.new(0,90,0,90),BackgroundTransparency=0.85,ZIndex=1,}},
			{8,"UICorner",{CornerRadius=UDim.new(1,0),Parent={7},}},
			{9,"Frame",{BackgroundColor3=Color3.fromRGB(255,0,120),BorderSizePixel=0,Name="Orb3",Parent={3},Position=UDim2.new(1,-20,0,-20),Size=UDim2.new(0,55,0,55),BackgroundTransparency=0.88,ZIndex=1,}},
			{10,"UICorner",{CornerRadius=UDim.new(1,0),Parent={9},}},
			-- Title
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-220,0,20),Size=UDim2.new(0,140,0,55),Text="Dex++",TextColor3=Color3.fromRGB(0,220,255),TextSize=54,TextTransparency=1,RichText=true,ZIndex=3,}},
			-- Rainbow glow behind title
			{12,"Frame",{BackgroundColor3=Color3.fromRGB(0,220,255),BorderSizePixel=0,Name="TitleGlow",Parent={3},Position=UDim2.new(0,45,0,15),Size=UDim2.new(0,160,0,65),BackgroundTransparency=1,ZIndex=2,}},
			{13,"UIGradient",{Name="GlowGradient",Parent={12},Color=ColorSequence.new({ColorSequenceKeypoint.new(0,Color3.fromRGB(0,220,255)),ColorSequenceKeypoint.new(0.5,Color3.fromRGB(180,0,255)),ColorSequenceKeypoint.new(1,Color3.fromRGB(255,0,120))}),Rotation=0,}},
			{14,"UICorner",{CornerRadius=UDim.new(0,12),Parent={12},}},
			-- Desc
			{15,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-270,0,78),Size=UDim2.new(0,230,0,22),Text="Ultimate Debugging Suite",TextColor3=Color3.fromRGB(180,200,255),TextSize=15,TextTransparency=1,ZIndex=3,}},
			-- Rainbow separator line
			{16,"Frame",{BackgroundColor3=Color3.fromRGB(0,220,255),BorderSizePixel=0,Name="Sep",Parent={3},Position=UDim2.new(0,20,0,103),Size=UDim2.new(0,0,0,2),BackgroundTransparency=1,ZIndex=3,}},
			{17,"UIGradient",{Name="SepGradient",Parent={16},Color=ColorSequence.new({ColorSequenceKeypoint.new(0,Color3.fromRGB(0,220,255)),ColorSequenceKeypoint.new(0.5,Color3.fromRGB(200,0,255)),ColorSequenceKeypoint.new(1,Color3.fromRGB(255,60,160))}),}},
			-- Status text
			{18,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="StatusText",Parent={3},Position=UDim2.new(0,20,0,135),Size=UDim2.new(0,260,0,18),Text="Initializing",TextColor3=Color3.fromRGB(150,180,255),TextSize=13,TextTransparency=1,ZIndex=3,}},
			-- Loading dots
			{19,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Dots",Parent={3},Position=UDim2.new(0,20,0,155),Size=UDim2.new(0,60,0,18),Text="",TextColor3=Color3.fromRGB(0,220,255),TextSize=16,TextTransparency=1,ZIndex=3,}},
			-- Progress bar BG
			{20,"Frame",{BackgroundColor3=Color3.fromRGB(20,20,45),BorderSizePixel=0,Name="ProgressBar",Parent={3},Position=UDim2.new(0,130,0,178),Size=UDim2.new(0,0,0,6),ZIndex=3,}},
			{21,"UICorner",{CornerRadius=UDim.new(1,0),Parent={20},}},
			-- Progress bar fill
			{22,"Frame",{BackgroundColor3=Color3.fromRGB(0,220,255),BorderSizePixel=0,Name="Bar",Parent={20},Size=UDim2.new(0,0,1,0),ZIndex=4,}},
			{23,"UICorner",{CornerRadius=UDim.new(1,0),Parent={22},}},
			{24,"UIGradient",{Name="BarGradient",Parent={22},Color=ColorSequence.new({ColorSequenceKeypoint.new(0,Color3.fromRGB(0,220,255)),ColorSequenceKeypoint.new(0.5,Color3.fromRGB(180,0,255)),ColorSequenceKeypoint.new(1,Color3.fromRGB(255,60,160))}),}},
			-- Corner accents TL
			{25,"Frame",{BackgroundColor3=Color3.fromRGB(0,220,255),BorderSizePixel=0,Name="CornerTLV",Parent={3},Position=UDim2.new(0,0,0,0),Size=UDim2.new(0,2,0,0),ZIndex=5,}},
			{26,"Frame",{BackgroundColor3=Color3.fromRGB(0,220,255),BorderSizePixel=0,Name="CornerTLH",Parent={3},Position=UDim2.new(0,0,0,0),Size=UDim2.new(0,0,0,2),ZIndex=5,}},
			-- Corner accents BR
			{27,"Frame",{BackgroundColor3=Color3.fromRGB(255,60,160),BorderSizePixel=0,Name="CornerBRV",Parent={3},Position=UDim2.new(1,-2,1,0),AnchorPoint=Vector2.new(0,1),Size=UDim2.new(0,2,0,0),ZIndex=5,}},
			{28,"Frame",{BackgroundColor3=Color3.fromRGB(255,60,160),BorderSizePixel=0,Name="CornerBRH",Parent={3},Position=UDim2.new(1,0,1,-2),AnchorPoint=Vector2.new(1,0),Size=UDim2.new(0,0,0,2),ZIndex=5,}},
			-- Creator / Version
			{29,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-135,1,-22),Size=UDim2.new(0,130,0,18),Text="Developed by Chillz.",TextColor3=Color3.fromRGB(100,120,180),TextSize=13,TextXAlignment=1,}},
			{30,"UIGradient",{Parent={29},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			{31,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Version",Parent={2},Position=UDim2.new(1,-135,1,-38),Size=UDim2.new(0,130,0,18),Text=Main.Version,TextColor3=Color3.fromRGB(100,120,180),TextSize=13,TextXAlignment=1,}},
			{32,"UIGradient",{Parent={31},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			-- Outer outline
			{33,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,Image="rbxassetid://1427967925",Name="Outlines",Parent={2},Position=UDim2.new(0,-5,0,-5),ScaleType=1,Size=UDim2.new(1,10,1,10),SliceCenter=Rect.new(6,6,25,25),TileSize=UDim2.new(0,20,0,20),}},
			{34,"UIGradient",{Parent={33},Rotation=-30,Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			{35,"UIGradient",{Parent={2},Rotation=-30,Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			{36,"UIDragDetector",{Parent={2}}}
		})
		Main.ShowGui(gui)
		...
		local titleGlow        = gui.Main.Holder.TitleGlow
		local glowGradient     = titleGlow.GlowGradient
		local descText         = gui.Main.Holder.Desc
		local sepLine          = gui.Main.Holder.Sep
		local sepGradient      = sepLine.SepGradient
		...
		local dotsLabel        = gui.Main.Holder.Dots
		...
		local orb1             = gui.Main.Holder.Orb1
		local orb2             = gui.Main.Holder.Orb2
		local orb3             = gui.Main.Holder.Orb3
		...
		-- Slide in title & desc
		tweenS:Create(titleText, ti, {Position = UDim2.new(0, 50, 0, 20), TextTransparency = 0}):Play()
		tweenS:Create(descText,  ti, {Position = UDim2.new(0, 20, 0, 78), TextTransparency = 0}):Play()
		...
		-- ── PHASE 3: Corner accents + separator ────────────────────────
		local cornerTI = TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
		tweenS:Create(cornerTLV, cornerTI, {Size = UDim2.new(0, 2, 0, 40)}):Play()
		tweenS:Create(cornerTLH, cornerTI, {Size = UDim2.new(0, 40, 0, 2)}):Play()
		tweenS:Create(cornerBRV, cornerTI, {Size = UDim2.new(0, 2, 0, 40)}):Play()
		tweenS:Create(cornerBRH, cornerTI, {Size = UDim2.new(0, 40, 0, 2)}):Play()
		tweenS:Create(sepLine, cornerTI, {Size = UDim2.new(0, 200, 0, 2), BackgroundTransparency = 0.3}):Play()

		fastwait(0.35)

		-- ── PHASE 4: Glitch on title ────────────────────────────────────
		coroutine.wrap(function()
			local offsets = {-4, 4, -2, 3, -1, 0}
			for _, ox in ipairs(offsets) do
				titleText.Position   = UDim2.new(0, 50 + ox, 0, 20)
				titleText.TextColor3 = ox ~= 0 and Color3.fromRGB(255, 40, 100) or Color3.fromRGB(0, 220, 255)
				fastwait(0.038)
			end
			titleText.Position   = UDim2.new(0, 50, 0, 20)
			titleText.TextColor3 = Color3.fromRGB(0, 220, 255)
		end)()

		fastwait(0.1)

		-- ── PHASE 5: Status + progress bar + dots ──────────────────────
		local progressTI = TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out)
		tweenS:Create(statusText, progressTI, {Position = UDim2.new(0, 20, 0, 138), TextTransparency = 0}):Play()
		tweenS:Create(dotsLabel,  progressTI, {Position = UDim2.new(0, 20, 0, 158), TextTransparency = 0}):Play()
		...
		local loopsRunning = true

		-- ── LOOP 1: Rainbow glow on title + outline ─────────────────────
		coroutine.wrap(function()
			local hue = 0
			while loopsRunning do
				...
				-- Rainbow corners
				cornerTLV.BackgroundColor3 = c
				cornerTLH.BackgroundColor3 = c
				local c2 = Color3.fromHSV((hue + 0.5) % 1, 1, 1)
				cornerBRV.BackgroundColor3 = c2
				cornerBRH.BackgroundColor3 = c2
				-- Rainbow separator
		...
		-- ── LOOP 2: Rainbow shimmer on progress bar ─────────────────────
		coroutine.wrap(function()
			local hue = 0
			while loopsRunning do
				hue = (hue + 0.012) % 1
				barGradient.Color = ColorSequence.new({
					...
					ColorSequenceKeypoint.new(0.33, Color3.fromHSV((hue + 0.25) % 1, 1, 1)),
					ColorSequenceKeypoint.new(0.66, Color3.fromHSV((hue + 0.5) % 1, 1, 1)),
					ColorSequenceKeypoint.new(1,   Color3.fromHSV((hue + 0.75) % 1, 1, 1))
				})
				fastwait()
			end
		end)()

		-- ── LOOP 3: Title glow pulse ────────────────────────────────────
		coroutine.wrap(function()
			local hue = 0
			while loopsRunning do
				hue = (hue + 0.005) % 1
				local pulse = 0.75 + math.abs(math.sin(tick() * 2.5)) * 0.2
				titleGlow.BackgroundTransparency = pulse
		...
		-- ── LOOP 4: Floating orbs animation ────────────────────────────
		coroutine.wrap(function()
			while loopsRunning do
				local t = tick()
				orb1.Position = UDim2.new(0, -30 + math.sin(t * 0.8) * 15, 0, -30 + math.cos(t * 0.6) * 12)
				orb2.Position = UDim2.new(1, -50 + math.cos(t * 0.7) * 18, 1, -50 + math.sin(t * 0.9) * 14)
				orb3.Position = UDim2.new(1, -20 + math.sin(t * 1.1) * 10, 0, -20 + math.cos(t * 0.8) * 10)
				orb1.BackgroundColor3 = Color3.fromHSV(tick() * 0.15 % 1, 1, 1)
				orb2.BackgroundColor3 = Color3.fromHSV((tick() * 0.15 + 0.33) % 1, 1, 1)
				orb3.BackgroundColor3 = Color3.fromHSV((tick() * 0.15 + 0.66) % 1, 1, 1)
				fastwait()
			end
		end)()

		-- ── LOOP 5: Animated loading dots ──────────────────────────────
		coroutine.wrap(function()
			local dotStates = {"", ".", "..", "..."}
			local idx = 1
			while loopsRunning do
				dotsLabel.Text = dotStates[idx]
				idx = idx % 4 + 1
				fastwait(0.4)
			end
		end)()

		-- ── LOOP 6: Progress bar bounce glow ───────────────────────────
		coroutine.wrap(function()
			local bounceTI = TweenInfo.new(0.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut)
			while loopsRunning do
				tweenS:Create(progressBar, bounceTI, {Size = UDim2.new(0, 220, 0, 8)}):Play()
				fastwait(0.5)
				tweenS:Create(progressBar, bounceTI, {Size = UDim2.new(0, 220, 0, 5)}):Play()
				fastwait(0.5)
			end
		end)()

		-- ── setProgress ────────────────────────────────────────────────
		local progressUpdateTI = TweenInfo.new(0.35, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
		...
		local function close()
			...
			coroutine.wrap(function()
				for i = 1, 5 do
					...
					titleText.Position   = UDim2.new(0, 50 + ox, 0, 20)
					titleText.TextColor3 = Color3.fromHSV(i / 5, 1, 1)
					fastwait(0.03)
				end
				titleText.Position = UDim2.new(0, 50, 0, 20)
			end)()
			...
			tweenS:Create(titleGlow,   closeTI, {BackgroundTransparency = 1}):Play()
			...
			tweenS:Create(dotsLabel,   closeTI, {TextTransparency = 1}):Play()
			...
			tweenS:Create(orb1,        closeTI, {BackgroundTransparency = 1}):Play()
			tweenS:Create(orb2,        closeTI, {BackgroundTransparency = 1}):Play()
			tweenS:Create(orb3,        closeTI, {BackgroundTransparency = 1}):Play()
